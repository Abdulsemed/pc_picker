...
$query8 = "SELECT * FROM `user` WHERE Role = 'admin' ";
...
if ($num_admin == 0) {
    $query9 = "INSERT INTO user (`userName`, `First_name`, `Last_name`, `password`, `profilePicture`, `email`, `Role`) VALUES ('bebeX','Jhon', 'Doe' ,'{$pass}','admin.jpg', 'bebeX@gmail.com', 'admin')";
